...
class AllExceptionHandler(AbstractExceptionHandler):
    ...
    def handle(self, handler_input, exception):
        ...
        speech = "Sorry, I didn't understand, please repeat again."
...
skill_adapter = SkillAdapter(
    skill=skill_builder.create(), skill_id="amzn1.ask.skill.4deae1c7-7db7-46ba-a1f7-98610ec8692b", app=app)
