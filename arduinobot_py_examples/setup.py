...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "simple_service_clientt = arduinobot_py_examples.simple_service_client:main",
            ...
            "simple_lifecycle_publisher = arduinobot_py_examples.simple_lifecycle_publisher:main",
            "lifecycle_node_manager = arduinobot_py_examples.lifecycle_node_manager:main"
        ],
    },
)
